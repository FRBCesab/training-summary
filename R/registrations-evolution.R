registrations_evolution <- function() {
  ...
  png(
    filename = here::here("figures", "number_of_registrations.png"),
    width = 16,
    height = 8,
    units = "in",
    pointsize = 16,
  ...
  mtext(
    text = "Number of pre-registrations",
    side = 2,
    line = 2.2,
    cex = 1.4,
    font = 2
